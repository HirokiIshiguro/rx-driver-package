...
| `r_sdio_rx` | 1.00.saffti-original | [fitmodules/r_sdio_rx/r_sdio_rx](https://gitlab.saffti.jp/oss/experiment/embedded/mcu/renesas/rx/fitmodules/r_sdio_rx/r_sdio_rx) | SDIO protocol helper FIT module above an application-supplied host driver such as `r_sdhi_rx`. Provides CMD52/CMD53 wrappers, CCCR/FBR/CIS helpers, function enable polling, interrupt register helpers, and Broadcom/Infineon backplane-window access. CMD53 byte-mode function-1 read/write paths are proven on EK-RX671 with Murata Type 1YN. |
