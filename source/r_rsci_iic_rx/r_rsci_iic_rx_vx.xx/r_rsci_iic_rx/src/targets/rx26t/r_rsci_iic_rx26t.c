...
/* Defines for RSCI_IIC support */
    ...
    #include "r_rsci_iic_rx26t_private.h"
...
const rsci_iic_ch_rom_t g_rsci_iic_ch8_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPBL1.LONG, BIT24_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IER[IER_RSCI8_TXI].BYTE, BIT5_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENBL1.LONG, BIT24_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    BSP_INT_SRC_BL1_RSCI8_TEI,
    rsci_iic_int_rsci_iic8_tei_isr,
...
const rsci_iic_ch_rom_t g_rsci_iic_ch9_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPBL1.LONG, BIT26_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IER[IER_RSCI9_TXI].BYTE, BIT7_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENBL1.LONG, BIT26_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    BSP_INT_SRC_BL1_RSCI9_TEI,
    rsci_iic_int_rsci_iic9_tei_isr,
...
const rsci_iic_ch_rom_t g_rsci_iic_ch11_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&SYSTEM.MSTPCRC.LONG, BIT24_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IPR[IPR_RSCI11_TXI].BYTE,
    &ICU.IR[IR_RSCI11_TXI].BYTE,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPAL0.LONG, BIT12_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IER[IER_RSCI11_TXI].BYTE, BIT3_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENAL0.LONG, BIT12_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
...
rsci_iic_return_t r_rsci_iic_check_arguments(rsci_iic_info_t * p_rsci_iic_info, rsci_iic_api_mode_t called_api)
{
    ...
    if ((RSCI_IIC_NUM_CH8 != p_rsci_iic_info->ch_no) && (RSCI_IIC_NUM_CH9 != p_rsci_iic_info->ch_no)
    && (RSCI_IIC_NUM_CH11 != p_rsci_iic_info->ch_no))
    {
 ...
 * Return Value : None
 **********************************************************************************************************************/
void rsci_iic_int_rsci_iic8_tei_isr(void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
void rsci_iic_int_rsci_iic9_tei_isr(void)
{
