...
***********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_rsci_iic_rx26t_private.h
...
#ifndef RSCI_IIC_RX26T_PRIVATE_H
    #define RSCI_IIC_RX26T_PRIVATE_H
...
/* Sets to use multi-function pin controller. */
        ...
        #define RSCI_IIC_MPC_SSCL_INIT              ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #if (((RSCI_IIC_CH8_SSDA_GP == PORT2_GR) && (RSCI_IIC_CH8_SSDA_PIN == 1)) \
                || ((RSCI_IIC_CH8_SSDA_GP == PORT2_GR) && (RSCI_IIC_CH8_SSDA_PIN == 3)) \
                || ((RSCI_IIC_CH8_SSDA_GP == PORTB_GR) && (RSCI_IIC_CH8_SSDA_PIN == 0)))
                #define RSCI_IIC_MPC_SSDA008_ENABLE ((uint8_t)(0x2C))   /* Pin function select to RSCI8 SSDA pin:b101100 */
            #else
                #define RSCI_IIC_MPC_SSDA008_ENABLE ((uint8_t)(0x2D))   /* Pin function select to RSCI8 SSDA pin:b101101 */
            #endif
            #if ((RSCI_IIC_CH8_SSCL_GP == PORT2_GR) && (RSCI_IIC_CH8_SSCL_PIN == 2))
                #define RSCI_IIC_MPC_SSCL008_ENABLE ((uint8_t)(0x2C))   /* Pin function select to RSCI8 SSCL pin:b101100 */
            #else
                #define RSCI_IIC_MPC_SSCL008_ENABLE ((uint8_t)(0x2D))   /* Pin function select to RSCI8 SSCL pin:b101101 */
            #endif
        #endif /* RSCI_IIC_CFG_CH8_INCLUDED */

        #if (RSCI_IIC_CFG_CH9_INCLUDED)
                #define RSCI_IIC_MPC_SSDA009_ENABLE ((uint8_t)(0x2C))   /* Pin function select to RSCI9 SSDA pin:b101100 */
            #if ((RSCI_IIC_CH9_SSCL_GP == PORT0_GR) && (RSCI_IIC_CH9_SSCL_PIN == 0))
                #define RSCI_IIC_MPC_SSCL009_ENABLE ((uint8_t)(0x2C))   /* Pin function select to RSCI9 SSCL pin:b101100 */
            #else
                #define RSCI_IIC_MPC_SSCL009_ENABLE ((uint8_t)(0x2D))   /* Pin function select to RSCI9 SSCL pin:b101100 */
            #endif
        #endif /* RSCI_IIC_CFG_CH9_INCLUDED */

        #if (RSCI_IIC_CFG_CH11_INCLUDED)
                #define RSCI_IIC_MPC_SSDA011_ENABLE ((uint8_t)(0x2D))   /* Pin function select to RSCI11 SSDA pin:b101101 */
                #define RSCI_IIC_MPC_SSCL011_ENABLE ((uint8_t)(0x2D))   /* Pin function select to RSCI11 SSCL pin:b101101 */
...
typedef volatile struct st_rsci8 R_BSP_EVENACCESS_SFR * rsci_regs_t;
...
void rsci_iic_int_rsci_iic11_tei_isr(void);
    ...
    #endif /* BSP_MCU_RX26T */
#endif /* RSCI_IIC_RX26T_PRIVATE_H */
