...
***********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_rsci_iic_rx261_private.h
...
#ifndef RSCI_IIC_RX261_PRIVATE_H
    #define RSCI_IIC_RX261_PRIVATE_H
...
/* Sets to use multi-function pin controller. */
        ...
        #define RSCI_IIC_MPC_SSCL_INIT             ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #define RSCI_IIC_MPC_SSDA000_ENABLE    ((uint8_t)(0x0A)) /* Pin function select to RSCI0 SSDA pin:b01010 */
            #define RSCI_IIC_MPC_SSCL000_ENABLE    ((uint8_t)(0x0A)) /* Pin function select to RSCI0 SSCL pin:b01010 */
        #endif /* RSCI_IIC_CFG_CH0_INCLUDED */

        #if RSCI_IIC_CFG_CH8_INCLUDED
            #define RSCI_IIC_MPC_SSDA008_ENABLE    ((uint8_t)(0x0A)) /* Pin function select to RSCI8 SSDA pin:b01010 */
            #define RSCI_IIC_MPC_SSCL008_ENABLE    ((uint8_t)(0x0A)) /* Pin function select to RSCI8 SSCL pin:b01010 */
        #endif /* RSCI_IIC_CFG_CH8_INCLUDED */

        #if (RSCI_IIC_CFG_CH9_INCLUDED)
            #define RSCI_IIC_MPC_SSDA009_ENABLE    ((uint8_t)(0x0A)) /* Pin function select to RSCI9 SSDA pin:b01010 */
            #define RSCI_IIC_MPC_SSCL009_ENABLE    ((uint8_t)(0x0A)) /* Pin function select to RSCI9 SSCL pin:b01010 */
...
typedef volatile struct st_rsci0 R_BSP_EVENACCESS_SFR * rsci_regs_t;
...
extern void r_rsci_iic_mpc_setting (uint8_t port_gr, uint8_t pin_num, uint8_t set_value);
    ...
    #endif /* BSP_MCU_RX261 */
#endif /* RSCI_IIC_RX261_PRIVATE_H */
