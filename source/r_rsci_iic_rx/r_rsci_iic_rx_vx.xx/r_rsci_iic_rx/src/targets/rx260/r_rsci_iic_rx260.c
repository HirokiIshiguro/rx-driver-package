...
/* Defines for RSCI_IIC support */
    ...
    #include "r_rsci_iic_rx260_private.h"
...
/*----------------------------------------------------------------------------*/
    #if RSCI_IIC_CFG_CH0_INCLUDED
/* rom info */
const rsci_iic_ch_rom_t g_rsci_iic_ch0_rom =
{
    BSP_LOCK_RSCI0,
    (rsci_regs_t)&RSCI0, /* Cast to rsci_regs_t */
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&SYSTEM.MSTPCRB.LONG, BIT31_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IPR[IPR_RSCI0_TXI].BYTE,
    &ICU.IR[IR_RSCI0_TXI].BYTE,
    &ICU.IR[IR_RSCI0_TEI].BYTE, BIT0_MASK,
    &ICU.IER[IER_RSCI0_TXI].BYTE, BIT0_MASK,
    &ICU.IER[IER_RSCI0_TEI].BYTE, BIT1_MASK,
    RSCI_IIC_CFG_CH0_INT_PRIORITY,
    RSCI_IIC_CH0_SSCL_GP,
    RSCI_IIC_CH0_SSCL_PIN,
    RSCI_IIC_MPC_SSCL000_ENABLE,
    RSCI_IIC_CH0_SSDA_GP,
    RSCI_IIC_CH0_SSDA_PIN,
    RSCI_IIC_MPC_SSDA000_ENABLE,
    RSCI_IIC_CFG_CH0_SSDA_DELAY_SELECT,
    RSCI_IIC_CFG_CH0_BITRATE_BPS,
    RSCI_IIC_CFG_CH0_DIGITAL_FILTER,
    RSCI_IIC_CFG_CH0_FILTER_CLOCK
};

/* channel control block */
rsci_iic_ch_ctrl_t g_rsci_iic_ch0_ctrl =
{
    &g_rsci_iic_ch0_rom,
    RSCI_IIC_EV_INIT,
    RSCI_IIC_MODE_NONE,
    ...
    #endif /* RSCI_IIC_CFG_CH0_INCLUDED */

    #if RSCI_IIC_CFG_CH8_INCLUDED
/* rom info */
const rsci_iic_ch_rom_t g_rsci_iic_ch8_rom =
{
    BSP_LOCK_RSCI8,
    (rsci_regs_t)&RSCI8, /* Cast to rsci_regs_t */
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&SYSTEM.MSTPCRC.LONG, BIT27_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IPR[IPR_RSCI8_TXI].BYTE,
    &ICU.IR[IR_RSCI8_TXI].BYTE,
    &ICU.IR[IR_RSCI8_TEI].BYTE, BIT0_MASK,
    &ICU.IER[IER_RSCI8_TXI].BYTE, BIT0_MASK,
    &ICU.IER[IER_RSCI8_TEI].BYTE, BIT1_MASK,
    RSCI_IIC_CFG_CH8_INT_PRIORITY,
    RSCI_IIC_CH8_SSCL_GP,
    RSCI_IIC_CH8_SSCL_PIN,
    RSCI_IIC_MPC_SSCL008_ENABLE,
    RSCI_IIC_CH8_SSDA_GP,
    RSCI_IIC_CH8_SSDA_PIN,
    RSCI_IIC_MPC_SSDA008_ENABLE,
    RSCI_IIC_CFG_CH8_SSDA_DELAY_SELECT,
    RSCI_IIC_CFG_CH8_BITRATE_BPS,
    RSCI_IIC_CFG_CH8_DIGITAL_FILTER,
    RSCI_IIC_CFG_CH8_FILTER_CLOCK
};

/* channel control block */
rsci_iic_ch_ctrl_t g_rsci_iic_ch8_ctrl =
{
    &g_rsci_iic_ch8_rom,
    RSCI_IIC_EV_INIT,
    RSCI_IIC_MODE_NONE,
    ...
    #endif /* RSCI_IIC_CFG_CH8_INCLUDED */

    #if RSCI_IIC_CFG_CH9_INCLUDED
/* rom info */
const rsci_iic_ch_rom_t g_rsci_iic_ch9_rom =
{
    BSP_LOCK_RSCI9,
    (rsci_regs_t)&RSCI9, /* Cast to rsci_regs_t */
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&SYSTEM.MSTPCRC.LONG, BIT26_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IPR[IPR_RSCI9_TXI].BYTE,
    &ICU.IR[IR_RSCI9_TXI].BYTE,
    &ICU.IR[IR_RSCI9_TEI].BYTE, BIT0_MASK,
    &ICU.IER[IER_RSCI9_TXI].BYTE, BIT4_MASK,
    &ICU.IER[IER_RSCI9_TEI].BYTE, BIT5_MASK,
    RSCI_IIC_CFG_CH9_INT_PRIORITY,
    RSCI_IIC_CH9_SSCL_GP,
    RSCI_IIC_CH9_SSCL_PIN,
    RSCI_IIC_MPC_SSCL009_ENABLE,
    RSCI_IIC_CH9_SSDA_GP,
    RSCI_IIC_CH9_SSDA_PIN,
    RSCI_IIC_MPC_SSDA009_ENABLE,
    RSCI_IIC_CFG_CH9_SSDA_DELAY_SELECT,
    RSCI_IIC_CFG_CH9_BITRATE_BPS,
    RSCI_IIC_CFG_CH9_DIGITAL_FILTER,
    RSCI_IIC_CFG_CH9_FILTER_CLOCK
};

/* channel control block */
rsci_iic_ch_ctrl_t g_rsci_iic_ch9_ctrl =
{
    &g_rsci_iic_ch9_rom,
    RSCI_IIC_EV_INIT,
    RSCI_IIC_MODE_NONE,
    ...
    #endif /* RSCI_IIC_CFG_CH9_INCLUDED */
...
rsci_iic_return_t r_rsci_iic_check_arguments(rsci_iic_info_t * p_rsci_iic_info, rsci_iic_api_mode_t called_api)
{
    ...
    if ((RSCI_IIC_NUM_CH0 != p_rsci_iic_info->ch_no) && (RSCI_IIC_NUM_CH8 != p_rsci_iic_info->ch_no)
    && (RSCI_IIC_NUM_CH9 != p_rsci_iic_info->ch_no))
    {
...
static void rsci_iic_clear_ir_flag(rsci_iic_info_t * p_rsci_iic_info)
{
    ...
    #if RSCI_IIC_CFG_CH0_INCLUDED
/***********************************************************************************************************************
 * Function Name: rsci_iic_int_rsci_iic0_txi_isr
 * Description  : Interrupt TXI handler for channel 0.
 *                Types of interrupt requests transmission end.
 * Arguments    : None
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT (rsci_iic_int_rsci_iic0_txi_isr, VECT_RSCI0_TXI)
R_BSP_ATTRIB_STATIC_INTERRUPT void rsci_iic_int_rsci_iic0_txi_isr(void)
{
    r_rsci_iic_txi_isr_processing(RSCI_IIC_NUM_CH0);

    /* Calls advance function */
    r_rsci_iic_advance(g_rsci_iic_handles[RSCI_IIC_NUM_CH0]->prsci_iic_info_ch);
} /* End of function rsci_iic_int_rsci_iic0_txi_isr() */
    #endif

    #if RSCI_IIC_CFG_CH8_INCLUDED
/***********************************************************************************************************************
 * Function Name: rsci_iic_int_rsci_iic8_txi_isr
 * Description  : Interrupt TXI handler for channel 8.
 *                Types of interrupt requests transmission end.
 * Arguments    : None
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT (rsci_iic_int_rsci_iic8_txi_isr, VECT_RSCI8_TXI)
R_BSP_ATTRIB_STATIC_INTERRUPT void rsci_iic_int_rsci_iic8_txi_isr(void)
{
    r_rsci_iic_txi_isr_processing(RSCI_IIC_NUM_CH8);

    /* Calls advance function */
    r_rsci_iic_advance(g_rsci_iic_handles[RSCI_IIC_NUM_CH8]->prsci_iic_info_ch);
} /* End of function rsci_iic_int_rsci_iic8_txi_isr() */
    #endif

    #if RSCI_IIC_CFG_CH9_INCLUDED
/***********************************************************************************************************************
 * Function Name: rsci_iic_int_rsci_iic9_txi_isr
 * Description  : Interrupt TXI handler for channel 9.
 *                Types of interrupt requests transmission end.
 * Arguments    : None
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT (rsci_iic_int_rsci_iic9_txi_isr, VECT_RSCI9_TXI)
R_BSP_ATTRIB_STATIC_INTERRUPT void rsci_iic_int_rsci_iic9_txi_isr(void)
{
    r_rsci_iic_txi_isr_processing(RSCI_IIC_NUM_CH9);

    /* Calls advance function */
    r_rsci_iic_advance(g_rsci_iic_handles[RSCI_IIC_NUM_CH9]->prsci_iic_info_ch);
} /* End of function rsci_iic_int_rsci_iic9_txi_isr() */
    #endif

    #if RSCI_IIC_CFG_CH0_INCLUDED
/***********************************************************************************************************************
 * Function Name: rsci_iic_int_rsci_iic0_tei_isr
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT (rsci_iic_int_rsci_iic0_tei_isr, VECT_RSCI0_TEI)
R_BSP_ATTRIB_STATIC_INTERRUPT void rsci_iic_int_rsci_iic0_tei_isr(void)
{
    r_rsci_iic_tei_isr_processing(RSCI_IIC_NUM_CH0);

    /* Calls advance function */
    r_rsci_iic_advance(g_rsci_iic_handles[RSCI_IIC_NUM_CH0]->prsci_iic_info_ch);
} /* End of function rsci_iic_int_rsci_iic0_tei_isr() */
    #endif

    #if RSCI_IIC_CFG_CH8_INCLUDED
/***********************************************************************************************************************
 * Function Name: rsci_iic_int_rsci_iic8_tei_isr
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT (rsci_iic_int_rsci_iic8_tei_isr, VECT_RSCI8_TEI)
R_BSP_ATTRIB_STATIC_INTERRUPT void rsci_iic_int_rsci_iic8_tei_isr(void)
{
    r_rsci_iic_tei_isr_processing(RSCI_IIC_NUM_CH8);

    /* Calls advance function */
    r_rsci_iic_advance(g_rsci_iic_handles[RSCI_IIC_NUM_CH8]->prsci_iic_info_ch);
} /* End of function rsci_iic_int_rsci_iic8_tei_isr() */
    #endif

    #if RSCI_IIC_CFG_CH9_INCLUDED
/***********************************************************************************************************************
 * Function Name: rsci_iic_int_rsci_iic9_tei_isr
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT (rsci_iic_int_rsci_iic9_tei_isr, VECT_RSCI9_TEI)
R_BSP_ATTRIB_STATIC_INTERRUPT void rsci_iic_int_rsci_iic9_tei_isr(void)
{
    r_rsci_iic_tei_isr_processing(RSCI_IIC_NUM_CH9);

    /* Calls advance function */
    r_rsci_iic_advance(g_rsci_iic_handles[RSCI_IIC_NUM_CH9]->prsci_iic_info_ch);
} /* End of function rsci_iic_int_rsci_iic9_tei_isr() */
    #endif
