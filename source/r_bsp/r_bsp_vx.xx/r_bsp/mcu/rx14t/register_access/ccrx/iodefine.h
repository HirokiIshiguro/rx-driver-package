...
#define	GPTW0	(*(volatile struct st_gptw   __evenaccess *)0x96000)
#define	GPTW1	(*(volatile struct st_gptw   __evenaccess *)0x96100)
#define	GPTW2	(*(volatile struct st_gptw   __evenaccess *)0x96200)
...
#define	MTU		(*(volatile struct st_mtu    __evenaccess *)0x9520A)
#define	MTU0	(*(volatile struct st_mtu0   __evenaccess *)0x95290)
#define	MTU1	(*(volatile struct st_mtu1   __evenaccess *)0x95290)
#define	MTU2	(*(volatile struct st_mtu2   __evenaccess *)0x95292)
#define	MTU3	(*(volatile struct st_mtu3   __evenaccess *)0x95200)
#define	MTU4	(*(volatile struct st_mtu4   __evenaccess *)0x95200)
#define	MTU5	(*(volatile struct st_mtu5   __evenaccess *)0x95294)
#define	OFSM	(*(volatile struct st_ofsm   __evenaccess *)0xFFFFFF80)
#define	PGA0	(*(volatile struct st_pga    __evenaccess *)0x891A0)
#define	POE		(*(volatile struct st_poe    __evenaccess *)0x9E400)
