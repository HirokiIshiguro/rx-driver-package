...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_lvd_rx14t.h
* Description  : When a target product is selected, as for this header, it is done include.
***********************************************************************************************************************/
/***********************************************************************************************************************
* History      : DD.MM.YYYY Version  Description
*              : 30.10.2025 4.90     First Release for RX14T
***********************************************************************************************************************/
#ifndef LVD_RX14T_HEADER_FILE
#define LVD_RX14T_HEADER_FILE
...
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_1 == 416)
    #define LVD_VOLTAGE_LEVEL_VALUE_CH1         (1)
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_1 == 403)
    #define LVD_VOLTAGE_LEVEL_VALUE_CH1         (2)
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_1 == 386)
...
#if (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 432)
    #define LVD_VOLTAGE_LEVEL_VALUE_CH2         (0)
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 417)
    #define LVD_VOLTAGE_LEVEL_VALUE_CH2         (1)
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 403)
...
#define LVD_DELAY_CIRCUIT_ENABLE_USEC           (1200)
