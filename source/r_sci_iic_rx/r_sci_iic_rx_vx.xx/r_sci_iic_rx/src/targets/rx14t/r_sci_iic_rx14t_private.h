...
***********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_sci_iic_rx14t_private.h
...
#ifndef SCI_IIC_RX14T_PRIVATE_H
    #define SCI_IIC_RX14T_PRIVATE_H
/***********************************************************************************************************************
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #if ((SCI_IIC_CFG_CH1_SSDA_GP == PORTB_GR) && (SCI_IIC_CFG_CH1_SSDA_PIN == 5))
                #define SCI_IIC_MPC_SSDA1_ENABLE ((uint8_t)(0x0B))   /* Pin function select to SCI0 SSDA pin:b01011 */
            #else
                #define SCI_IIC_MPC_SSDA1_ENABLE ((uint8_t)(0x0A))   /* Pin function select to SCI0 SSDA pin:b01010 */
            #endif
            #if ((SCI_IIC_CFG_CH1_SSCL_GP == PORTB_GR) && (SCI_IIC_CFG_CH1_SSCL_PIN == 6))
                #define SCI_IIC_MPC_SSCL1_ENABLE ((uint8_t)(0x0B))   /* Pin function select to SCI0 SSCL pin:b01011 */
            #else
                #define SCI_IIC_MPC_SSCL1_ENABLE ((uint8_t)(0x0A))   /* Pin function select to SCI0 SSCL pin:b01010 */
            #endif
            ...
            #if ((SCI_IIC_CFG_CH6_SSDA_GP == PORT1_GR) && (SCI_IIC_CFG_CH6_SSDA_PIN == 1)) || \
                    ((SCI_IIC_CFG_CH6_SSDA_GP == PORT3_GR) && (SCI_IIC_CFG_CH6_SSDA_PIN == 7))
            ...
            #endif
            #if ((SCI_IIC_CFG_CH1_SSCL_GP == PORT3_GR) && (SCI_IIC_CFG_CH6_SSCL_PIN == 6))
